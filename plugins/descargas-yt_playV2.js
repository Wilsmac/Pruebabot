...
try {
if (command == 'play.1') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsAud, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: wm, previewType: 0, thumbnail: Menu3, sourceUrl: canalofc }}}) 
try { 
...
if (command == 'play.2') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsVid, m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: wm, previewType: 0, thumbnail: Menu3, sourceUrl: canalofc }}}) 
try {
...
sourceUrl: `https://github.com/Wilsmac`}}}) 
